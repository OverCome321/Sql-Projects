...
-- Table Количество_списков_созданных_пользователем

CREATE TABLE [Количество_списков_созданных_пользователем]
(
 [Attribute1] Int NOT NULL,
 [Attribute2] Int NOT NULL,
 [Дата] Smalldatetime NOT NULL,
 [Количество_списков] Int NULL
)
go

-- Table Просмотр_видеозаписи

CREATE TABLE [Просмотр_видеозаписи]
(
 [Attribute1] Int NOT NULL,
 [Код_видеозаписи] Int NOT NULL,
 [Дата] Smalldatetime NOT NULL,
 [Количество_просмотренных_видеозаписей] Int NULL
)
go

-- Table Запись_находится_в_категории

CREATE TABLE [Запись_находится_в_категории]
(
 [Attribute1] Int NOT NULL,
 [Код_видеозаписи] Int NOT NULL,
 [Дата] Smalldatetime NOT NULL,
 [Количество_записей_находящихся_в_категории] Int NULL
)
go
